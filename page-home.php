...
<div class="main_bg_home_page" style="background: url(<?php echo $bg_img;?>);">
	<div class="container main_container_home_page">
		...
		<div class="row mt-2 main_row_section_3_section-1">
            <div class="col-sm-12 col-lg-3 section1Anim">
                <div class="row">
                	<div class="col-sm-12">
            ...
            <div class="col-sm-12 col-lg-3 section1Anim mt-5 mt-sm-0">
                <div class="row">
                	<div class="col-sm-12">
            ...
            <div class="col-sm-12 col-lg-3 mt-5 mt-lg-0 section1Anim">
                <div class="row">
                	<div class="col-sm-12">
                ...
                <div class="home__section1__image animatedImage active">
                    ...
                    <div class="row mt-8 mt-sm-12">
                    	<div class="col-sm-12 animatedContent">
                    		<a href="investorsoverview" class="buttonWhite animatedButton button_asd" style="--x:115px;--y:">
        ...
        <div class="row mt-6 mt-sm-16 section_4_home_page">
                <div class="col-sm-12 text-center">
                    ...
                    <div class="row">
                    	<div class="col-sm-12 section1CAnim col-lg-8 offset-lg-2 para_ns_media">
                    ...
                    <div class="row mt-6 mt-sm-16">
                    	<div class="col-sm-12 col-lg-10 offset-lg-1">
                            <div class="row">
                                <div class="col-sm-12 col-lg-3 home__section1__icon section1DAnim">
                                    <div class="row">
                                    ...
                                    <div class="row mt-3">
                                    	<div class="col-sm-12 payload_media">Industry BPO Solution</div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-3 mt-12 mt-sm-0 mt-md-0 home__section1__icon section1DAnim">
                                    <div class="row">
                                    ...
                                    <div class="row mt-3">
                                    	<div class="col-sm-12 payload_media">eCommerce Solution</div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-3 mt-12 mt-sm-5 mt-lg-0 home__section1__icon section1DAnim">
                                    <div class="row">
                                    ...
                                    <div class="row mt-3">
                                    	<div class="col-sm-12 payload_media">Financial Services</div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-3 mt-12 mt-sm-5 mt-lg-0 home__section1__icon section1DAnim">
                                    <div class="row">
                                    ...
                                    <div class="row mt-3">
                                    	<div class="col-md-8 offset-md-2 col-lg-12 offset-lg-0 payload_media">Online / Offline Payday Loans</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-12 section1EAnim">
                    	<div class="col-sm-12 col-lg-8 offset-lg-2 para_ns_media">
                    ...
                    <div class="row mt-8 section1EAnim">
                    	<div class="col-sm-12">
                    		<a href="whatwedo" class="buttonBlue animatedButton btn_load_nmore">
	...
	<div class="main_container_home_page_bg_blog">
		<div class="container blog_container_homepage">
			<div class="row">
				<div class="col-sm-12 section3AAnim ">
					<h2 class="heading_homder_page">BLOG HEADLINES
					</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 section3AAnim">
					<h3 class="heaidng_main_homeropage">
						Latest Blog posts &amp; News
					</h3>
				</div>
			</div>
			<div class="row mt-4 row0blog">
			...
			<?php while ( $data_query->have_posts() ) : $data_query->the_post();?>
				<div class="col-sm-12 col-md-4 blogAnim">
		...
		<div class="row mt-7">
			<div class="col-sm-12">
				<a href="http://localhost/Heritage BPO/blog/" class="buttonBlue animatedButton btn_load_nmore" style="--x:125px;--y:">
					<span class="">
						VISIT OUR BLOG
					</span>
				</a>
